                ...
                <Dialog.Title className='text-3xl font-black'> Publique um anúncio </Dialog.Title>
                  ...
                  <form className='mt-8 flex flex-col gap-4'>
                    <div className='flex flex-col gap-2'>
                      ...
                      <Input id='game' placeholder='Selecionde o game que deseja jogar'/>
                    </div>
                      ...
                      <div className='flex flex-col gap-2'>
                        <label htmlFor="weekDays">Quando costuma jogar?</label>
                          ...
                          <div className='grid grid-cols-4 gap-2'>
                            <button title='Domingo'  className='w-8 h-8  rounded-sm bg-zinc-900 '>
                              D
                              </button>

                            <button title='Segunda' className='w-8 h-8 rounded-sm bg-zinc-900 '>
                              S
                              </button>

                            <button title='Terça' className='w-8 h-8 rounded-sm bg-zinc-900 '>
                              T
                              </button>

                            <button title='Quarta' className='w-8 h-8 rounded-sm bg-zinc-900 '>
                              Q
                              </button>

                            <button title='Quinta' className='w-8 h-8 rounded-sm bg-zinc-900'>
                              Q
                              </button>

                            <button title='Sexta' className='w-8 h-8 rounded-sm bg-zinc-900 '>
                              S
                              </button>

                            <button title='Sábado' className='w-8 h-8 rounded-sm bg-zinc-900'>
                              S
                            </button>
