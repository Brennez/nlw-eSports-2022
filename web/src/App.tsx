    ...
    <div className='max-w-[1344px] mx-auto flex flex-col items-center mt-20 mb-20'>
      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        ...
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0'>
              <strong className='font-bold text-white block'>Call od Duty</strong>
              <span className='text-sm text-zinc-300 block'>4 anúncios</span>
          </div>
        </a>
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch rounded-lg overflow-hidden mt-8'> 
          <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
            ...
            <button className='px-3 py-4 bg-violet-500 rounded hover:bg-violet-600 text-white flex items-center gap-3'>
              Publicar anúncio
